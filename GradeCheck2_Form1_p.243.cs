...
namespace GradeCheck2
{
    public partial class Form1 : Form
    {
        ...
        private void buttonJudge_Click(object sender, EventArgs e)
        {
            ...
            //出席時数の範囲チェック
            if (attendanceM < 0 || attendanceM > subjectM.TotalHours || attendanceP < 0 || attendanceP > subjectP.TotalHours|| attendanceE < 0 || attendanceE > subjectE.TotalHours)
            {
            ...
            Student student
                = new Student(textBoxName.Text, scoreM, scoreP, scoreE, attendanceM, attendanceP, attendanceE);
            ...
            labelResultE.Text = subjectP.OverPass(student.ScoreE, student.AttendanceE);
