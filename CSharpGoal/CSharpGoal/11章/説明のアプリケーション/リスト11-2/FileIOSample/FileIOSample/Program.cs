        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                using (StreamWriter writer1 =
                    new StreamWriter("test1.txt", false, Encoding.Default))
                {
            ...
            try
            {
                using (StreamWriter writer2 =
                    new StreamWriter("test1.txt", true, Encoding.Default))
                {
            ...
            try
            {
                using (StreamReader reader1 =
                    new StreamReader("test1.txt", Encoding.Default))
                {
