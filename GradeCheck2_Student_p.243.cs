...
namespace GradeCheck2
{
    class Student
    {
        ...
        private int attendanceM;    //数学の得点
        private int attendanceP;    //物理の得点
        private int attendanceE;    //英語の得点

        //コンストラクター：クラスの初期化メソッド
